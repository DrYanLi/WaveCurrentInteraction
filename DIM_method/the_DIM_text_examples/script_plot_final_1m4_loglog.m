...
% error estimates
subplot(1,4,2)
loglog(kv,R_kc,'--r',kv,R_EL,'-.b',kv,R01,'-k',kv,R02,'-..k',kv,R11,':k')
legend('K&C_{1st}','E&L_{1st}','M_0 = 1','M_0 = 2','M_{kc0}=1')
set(gca,'xlim',[0.01 100],'ylim',[10^-6 0.01],'FontName','Times New Roman','FontSize',10,'xtick',[0.01 0.1 1 10 100])
